        ...
        <article className="user-card m-7 mt-15 p-5 w-300">
            <section className="grid grid-cols-4">
                ...
                <figure className="w-25 col-start-5 m-5">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="fill-green-10 stroke-green-10">
            ...
            <div className="bg-white p-6 rounded shadow-md w-200 h-60 grid items-center">
                ...
                <p className="text-2xl text-black font-mw">Deseja realmente deletar este post?</p>
